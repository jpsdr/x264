...
static int generic_device_check( x264_param_t *param, const char *device, int device_mask )
{
...
{
    return x264_stack_align( generic_device_check, param, device, device_mask );
}

static int param_restrict_device( x264_param_t *param, int i_profile, const char *device )
{
...
{
    return x264_stack_align( param_restrict_device, param, i_profile, device );
}

static int param_apply_profile( x264_param_t *param, const char *profile, const char *device )
{
